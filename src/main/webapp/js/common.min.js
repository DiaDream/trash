...
function checkth() {
    $(".lxb-cb-input-btn").length > 0 && ($(".lxb-cb-input-btn").click(function () {
        _hmt.push(["_trackEvent", "LXB", "click", "æ‰“ç”µè¯"])
    }), window.clearInterval(checktag))
}

function textacc() {
    ga("send", "event", "å•†åŠ¡é€š", "æŽ¥å—", "chat")
}
    ...
    var t = $(".fixBar"), e = $(".fixbar-expand"), n = {
        elemScroll: function () {
            ...
            var t = $(this).data("src") || $(this).attr("data-src"),
                e = $(this).data("title") || $(this).attr("data-title") || "è§†é¢‘";
            layer.open({
                type: 1,
                shade: .8,
                title: e,
                ...
                shadeClose: !0,
                scrollbar: !1,
                content: '<video controls="controls" width="630" height="360"><source src="' + t + '" type="video/mp4"></source></video>'
            })
        }, freeChat: function () {
            $(".lxb-hide-btn").data("lxb") && $("#LXB_CONTAINER").css("cssText", 'top:200px !important;right:38px !important;height: 154px; width: 99px; border: 0px none rgb(0, 0, 0); background-image: url("http://lxb.baidu.com/image/module/271796_195646_20160922103705.png?t=1474511823835"); background-color: rgb(255, 255, 255); position: fixed; display: block !important;')
        }, fbexpand: function () {
...
}), $(".dropdown").click(function (t) {
    $(this).children("ul").hasClass("dropdown-active") ? $(this).children("ul").removeClass("dropdown-active") : $(this).children("ul").addClass("dropdown-active"), t.stopPropagation()
...
//document.writeln("<script language='javascript' src='http://pet.zoosnet.net/JS/LsJS.aspx?siteid=PET93654447&float=1&lng=cn'></script>"),
//  // for PPC - æ ‡ç­¾ä¼ é€’ä»£ç 
//  //d=document.domain;c=location.search;tags = document.getElementsByTagName("a");for(var i=0;i<tags.length;i++){if(tags[i].href.indexOf('?')==-1 && tags[i].href.indexOf(d)>-1){tags[i].href=tags[i].href+c;}}
//document.writeln('<script type="text/javascript" charset="utf-8" async src="http://lxbjs.baidu.com/lxb.js?sid=669695"></script>');
...
m = setInterval(function () {
    $(".lxb-hide-btn").length > 0 && (clearInterval(m), $(".lxb-hide-btn").data("lxb", "lxb").unbind(), $("#LXB_CONTAINER").css("cssText", 'top:200px !important;right:9999px !important;height: 154px; width: 99px; border: 0px none rgb(0, 0, 0); background-image: url("http://lxb.baidu.com/image/module/271796_195646_20160922103705.png?t=1474511823835"); background-color: rgb(255, 255, 255); position: fixed; display: block !important;'), $(".lxb-hide-btn").on("click", function (t) {
        t.preventDefault(), t.stopPropagation(), $("#LXB_CLOSE_BTN").hide(), $("#LXB_CONTAINER").hide()
    }))
}, 200), $(".p-inquiry").attr({
    href: "http://pet.zoosnet.net/LR/Chatpre.aspx?id=PET93654447&cid=1458097416715713489884&lng=cn&sid=1458097416715713489884",
    target: "_blank"
});
...
var func = {
    setBreadUrl: function (e) {
        var t = {
                products: {deep: 0, url: "/products/", title: "äº§å“"},
                mill: {deep: 1, url: "/products/mill/", title: "å·¥ä¸šåˆ¶ç²‰"},
                mine: {deep: 1, url: "/products/mine/", title: "çŸ¿å±±å¤„ç†"},
                material: {deep: 1, url: "/products/material/", title: "ç»¿è‰²å»ºæ"},
                aggregate: {deep: 1, url: "/products/aggregate/", title: "å»ºç­‘éª¨æ–™"}
        ...
        function i() {
            ...
            s && a || (s = function (e, t) {
                ...
                centerX = u.width / 2, centerY = u.height / 2, rad = 2 * Math.PI / 360, f.save(), f.beginPath(), f.strokeStyle = "#eee", f.lineWidth = 10, f.arc(centerX, centerY, 70, 0, 2 * Math.PI, !1), f.stroke(), f.closePath(), f.textAlign = "center", f.textBaseline = "middle", f.fillStyle = "#2e99eb", f.font = "30px å¾®è½¯é›…é»‘", f.fillText(c, centerX, centerY), f.fillStyle = "#c0c0c0", f.font = "20px å¾®è½¯é›…é»‘", f.fillText(d, centerX, centerY + 30), f.restore(), s(e)
            })
        }
...
var jModule = function (e, t, i) {
    ...
    }(window, document, jQuery), pattern = /[\w-\d]+\.html/,
...
jModule.jCs(millPage, location.href, function () {
    jModule.jAs("script", "/js/filter.js", function () {
        ...
        e.infinitescroll({
            ...
            dataType: "html",
            loading: {
                finishedMsg: "<em>æ²¡æœ‰æ›´å¤šäº†</em>",
                img: "/js/infinite-scroll/img/ajax-loader1.gif",
                msgText: "<em>æ­£åœ¨åŠ è½½...</em>",
                speed: "slow"
            }
        }, function (e) {
            jModule.jDs()
