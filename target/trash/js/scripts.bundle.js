...
$(document).ready(function ()
            ...
            if (!e(this).hasClass("m-datatable--loaded"))
            {
                ...
                var n = {
                    ...
                    extractTable: function ()
                    {
                        var n = [],
                            o = e(a).find("tr:first-child th").get().map(function (a, o)
                            {
                                ...
                                for (var l in t.columns) t.columns[l].field === a && (i = e.extend(!0,
                                {}, t.columns[l], i));
                                return n.push(i), a
                            });
                        t.columns = n;
                    ...
                    getData: function ()
                    {
                        ...
                        return "local" === t.data.type && (i.url = t.data.source), "remote" === t.data.type && (i.url = o.getOption("data.source.read.url"), "string" != typeof i.url && (i.url = o.getOption("data.source.read")), "string" != typeof i.url && (i.url = o.getOption("data.source")), i.headers = o.getOption("data.source.read.headers"), i.data.datatable = e.extend(
                        {}, o.getDataSourceParam(), o.getOption("data.source.read.params")), i.method = "POST", o.getOption("data.serverPaging") || delete i.data.datatable.pagination, o.getOption("data.serverSorting") || delete i.data.datatable.sort), e.ajax(i).done(function (t, o, i)
                        {
                    ...
                    {
                        var o = n.stateGet(t);
                        void 0 !== o && null !== o || (o = {}), n.stateKeep(t, e.extend(
                        {}, o, a))
                    },
            ...
            var a = {},
                ...
                o = {
                    ...
                    init: function (t)
                    {
                        ...
                        {}, e.fn.mDropdown.defaults, t), !0 === n.data("drop-auto") ? a.options.dropAuto = !0 : !1 === n.data("drop-auto") && (a.options.dropAuto = !1), a.scrollable.length > 0 && (a.scrollable.data("min-height") && (a.options.minHeight = a.scrollable.data("min-height")), a.scrollable.data("max-height") && (a.options.maxHeight = a.scrollable.data("max-height")))
                    },
                    build: function ()
                    {
        ...
        e.fn.mExample = function (t)
        {
            var a = {},
                ...
                o = {
                    ...
                    init: function (t)
                    {
                        a.events = [], a.scrollable = n.find(".m-example__scrollable"), a.options = e.extend(!0,
                        {}, e.fn.mExample.defaults, t), a.scrollable.length > 0 && (a.scrollable.data("data-min-height") && (a.options.minHeight = a.scrollable.data("data-min-height")), a.scrollable.data("data-max-height") && (a.options.maxHeight = a.scrollable.data("data-max-height")))
                    },
                    build: function ()
                    {
            ...
            var a = this,
                ...
                o = {
                    ...
                    init: function (t)
                    {
                        ...
                        {}, e.fn.mMenu.defaults, t), a.pauseDropdownHoverTime = 0
                    },
                    build: function ()
                    {
        ...
        e.fn.mMessenger = function (t)
        {
            var a = {},
                ...
                o = {
                    ...
                    init: function (t)
                    {
                        a.events = [], a.scrollable = n.find(".m-messenger__scrollable"), a.options = e.extend(!0,
                        {}, e.fn.mMessenger.defaults, t), a.scrollable.length > 0 && (a.scrollable.data("data-min-height") && (a.options.minHeight = a.scrollable.data("data-min-height")), a.scrollable.data("data-max-height") && (a.options.maxHeight = a.scrollable.data("data-max-height")))
                    },
                    build: function ()
                    {
                        mUtil.isMobileDevice()
        ...
        e.fn.mPortlet = function (t)
        {
            var a = {},
                ...
                o = {
                    ...
                    {
                        a.options = e.extend(!0,
                        {}, e.fn.mPortlet.defaults, t), a.events = [], a.eventOne = !1, a.body = n.find("> .m-portlet__body")
                    },
                    build: function ()
                    {
        ...
        e.fn.mQuicksearch = function (t)
        {
            var a = this,
                ...
                o = {
                    ...
                    {
                        a.options = e.extend(!0,
                        {}, e.fn.mQuicksearch.defaults, t), a.form = n.find("form"), a.input = e(a.options.input), a.iconClose = e(a.options.iconClose), "default" == a.options.type && (a.iconSearch = e(a.options.iconSearch), a.iconCancel = e(a.options.iconCancel)), a.dropdown = n.mDropdown(
                        {
                            mobileOverlay: !1
        ...
        e.fn.mScrollTop = function (t)
        {
            var a = this,
                ...
                o = {
                    ...
                    init: function (t)
                    {
                        a.element = n, a.events = [], a.options = e.extend(!0,
                        {}, e.fn.mScrollTop.defaults, t)
                    },
                    build: function ()
                    {
        ...
        e.fn.mToggle = function (t)
        {
            var a = this,
                ...
                o = {
                    ...
                    {
                        a.element = n, a.events = [], a.options = e.extend(!0,
                        {}, e.fn.mToggle.defaults, t), a.target = e(a.options.target), a.targetState = a.options.targetState, a.togglerState = a.options.togglerState, a.state = mUtil.hasClasses(a.target, a.targetState) ? "on" : "off"
                    },
                    build: function ()
                    {
                        n.on("click", o.toggle)
    ...
    }), $.fn.markdown.defaults.iconlibrary = "fa", $.fn.timepicker.defaults = $.extend(!0,
    ...
    var e, t, a, n, o = function ()
        ...
        c = function ()
        {
            ...
            e.mQuicksearch(
            {
                ...
                // 搜索框按键事件触发的查询地址，直接将从该地址返回的html显示出来，java方法中需要设置response.setHeader("Access-Control-Allow-Origin","*")激活跨域访问
                source: "http://localhost:8080/backFoxkissme/admin/toProfile",
