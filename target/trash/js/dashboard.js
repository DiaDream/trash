    ...
    var e = function (e, t, a, r)
        ...
        f = function ()
        {
            function e(e, a, r)
            {
                var o = "",
                    l = "";
                (a - e < 100 || "今天" == r) ? (o = "今天:", l = e.format("MM-DD")) : "昨天" == r ? (o = "昨天:", l = e.format("MM-DD")) : l = e.format("MM-DD") + " - " + a.format("MM-DD"), t.find(".m-subheader__daterange-date").html(l), t.find(".m-subheader__daterange-title").html(o)
            }
